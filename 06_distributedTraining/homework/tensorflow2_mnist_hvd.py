...
parser.add_argument('--device', default='gpu',
                    help='Whether this runs on cpu or gpu')
...
hvd.init()
print("# I am rank index %d of max %d" %(hvd.rank(), hvd.size() - 1))
...
for ep in range(args.epochs):
    ...
    for batch, (images, labels) in enumerate(dataset.take(nstep)):
        ...
        ### 5. Broadcast variables from rank 0.
